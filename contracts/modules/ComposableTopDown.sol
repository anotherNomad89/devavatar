...
import "./ERC20AndERC223.sol";  
import "./ERC998ERC721BottomUp.sol";

contract ComposableTopDown is ERC721Basic, ERC998ERC721TopDown, ERC998ERC721TopDownEnumerable,
ERC998ERC20TopDown, ERC998ERC20TopDownEnumerable, SupportsInterfaceWithLookup {
   ...
   */
    ...
    function receiveChild(address _from, uint256 _tokenId, address _childContract, uint256 _childTokenId) internal {
