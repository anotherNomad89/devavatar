  ...
  render() {
    ...
    if (displayData === "0") {
      output = (
        <div>
          <h3>
            "You do not own a DevAvatar yet. Click below to collect your own
            DevAvatar!"
          </h3>
          <ContractForm
            contract="DevAvatar"
            method="mint"
            methodArgs={[this.props.name]}
          />
        </div>
      );
...
export default drizzleConnect(Poller, mapStateToProps);
